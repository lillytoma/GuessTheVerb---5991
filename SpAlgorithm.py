...
verbs = [
    "saltar", "correr", "comer", "dormir", "reír", "llorar", "cantar", 
    "bailar", "nadar", "escribir", "leer", "pensar", "hablar", "escuchar", 
    "cocinar", "jugar", "trabajar", "estudiar", "dibujar", "pintar", 
    "escalar", "conducir", "volar", "luchar", "viajar", "construir", 
    "limpiar", "lavar", "arreglar", "cortar", "crecer", "plantar", 
    "conducir", "empujar", "tirar", "lanzar", "atrapar", "patear", 
    "golpear", "disparar", "apuñalar", "salvar", "gastar", "ganar", 
    "vender", "comprar", "enseñar", "aprender", "programar"
]
